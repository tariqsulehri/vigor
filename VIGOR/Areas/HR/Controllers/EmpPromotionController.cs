...
namespace VIGOR.Areas.HR.Controllers
{
    public class EmpPromotionController : Controller
    {
        ...
        // GET: HR/EmpPromotion/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: HR/EmpPromotion/Create
        ...
        // POST: HR/EmpPromotion/Create
        [HttpPost]
        public ActionResult Create(HR_History model)
        {
            try
            {
                model.PromotionType = "P";
                model.CreatedBy = 0;
                model.ModifiedBy = 0;
        ...
        // GET: HR/EmpPromotion/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: HR/EmpPromotion/Edit/5
        [HttpPost]
        ...
        // GET: HR/EmpPromotion/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: HR/EmpPromotion/Delete/5
        [HttpPost]
