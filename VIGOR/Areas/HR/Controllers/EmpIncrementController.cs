                ...
                foreach (var Key in empAllownaceList)
                {
                    ...
                    if (Request.Form.AllKeys.Any(k => k == "det[" + index + "][AllowanceID]"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(Request.Form["det[" + index + "][AllowanceID]"]))
                        {
                            ...
                            var total = _hrEmployeeAllowances.Amount;
                            totalAllowanceAmount = totalAllowanceAmount + total;
                ...
                foreach (var Key in empAllownaceList)
                {
                    ...
                    if (Request.Form.AllKeys.Any(k => k == "det[" + index + "][AllowanceID]"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(Request.Form["det[" + index + "][AllowanceID]"]))
                        {
                            ...
                            _historyDetails.Amount = totalAllowanceAmount;
                                //Convert.ToDecimal(Request.Form["det[" + index + "][Amount]"]);
