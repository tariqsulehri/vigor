...
{
    public class fnCPVController : Controller
    {
        ...
        // voucherRepo.GetAllFinVouchers("002").ToList()
        ...
        public ActionResult GetList(String vType, DateTime dateFrom, DateTime dateTo, string GlCode, string Detail)
        {
            ...
            var Collection = a.Select(x => new
            {
                ...
                ViewURL = "/GL/fnCPV/CpvView?vKey=" + x.VKey
        ...
        public ActionResult CpvView(string VKey)
        {
        ...
        // GET: GL/fnCPV/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: GL/fnCPV/Delete/5
        [HttpPost]
        ...
        public JsonResult PostVoucher(string vKey, string Url)
        {
            try
            {
