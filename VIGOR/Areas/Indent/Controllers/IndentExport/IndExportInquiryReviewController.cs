...
namespace VIGOR.Areas.Indent.Controllers.IndentExport
{
    public class IndExportInquiryReviewController : Controller
    {
        ...
        public ActionResult Create(int id)
        {
            ...
            var inquiryReview = model.IndExportInquiryReview.Where(a => a.Status).ToList();
            var inquiryReviewQuestions = _indExportInquiryReviewQuestionRepository.GetAllQuestions().ToList();
            ...
            ViewBag.IndExportInquiryReviewQuestions = inquiryReviewQuestions;
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (model.InquiryId > 0)
                    {
                        ...
                        //indExportInquiry.InquieryStatus = "P";
                        indExportInquiry.IsClosed = Convert.ToString((char)InquieryStatus.Active);
                ...
                return RedirectToAction("Create", "IndentExport", new { id = model.InquiryId });
