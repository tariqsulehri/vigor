...
namespace VIGOR.Areas.General.Controllers.Settings
{
    public class DepartmentController : Controller
    {
        ...
        // GET: General/Department/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: General/Department/Create
        ...
        // POST: General/Department/Create
        [HttpPost]
        ...
        // GET: General/Department/Edit/5
        public ActionResult Edit(int id)
        {
            return View(_hrDepartmentRepository.FindById(id));
        }

        // POST: General/Department/Edit/5
        [HttpPost]
        ...
        // GET: General/Department/Delete/5
        ...
        // POST: General/Department/Delete/5
        [HttpPost]
