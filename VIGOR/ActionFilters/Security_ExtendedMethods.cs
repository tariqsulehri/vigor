...
namespace VIGOR
{
    public static class Security_ExtendedMethods
    {
        ...
        //        bFound = new SecurityUser(controller.ControllerContext.HttpContext.User.Identity.Name).HasRole(role);
        //    }
        //    catch { }
        //    return bFound;
        //}
        ...
        //        bFound = new SecurityUser(controller.ControllerContext.HttpContext.User.Identity.Name).HasRoles(roles);
        //    }
        //    catch { }
        //    return bFound;
        //}
        ...
        //        bFound = new SecurityUser(controller.ControllerContext.HttpContext.User.Identity.Name).HasPermission(permission);
        //    }
        //    catch { }
        //    return bFound;
        //}
        ...
        //        bIsSysAdmin = new SecurityUser(controller.ControllerContext.HttpContext.User.Identity.Name).IsSysAdmin;
        //    }
        //    catch { }
        //    return bIsSysAdmin;
        //}
