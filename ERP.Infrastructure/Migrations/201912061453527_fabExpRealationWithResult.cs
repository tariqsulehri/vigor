namespace ERP.Infrastructure.Migrations
{
    ...
    public partial class fabExpRealationWithResult : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.FabricInspReportExport4PointResults", "InspectionSerialNo", c => c.String(maxLength: 8));
            AlterColumn("dbo.FabricInspReportExports", "width", c => c.Decimal(precision: 18, scale: 2, storeType: "numeric"));
            CreateIndex("dbo.FabricInspReportExport4PointResults", "InspectionSerialNo");
            AddForeignKey("dbo.FabricInspReportExport4PointResults", "InspectionSerialNo", "dbo.FabricInspReportExports", "InspectionSerialNoID");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.FabricInspReportExport4PointResults", "InspectionSerialNo", "dbo.FabricInspReportExports");
            DropIndex("dbo.FabricInspReportExport4PointResults", new[] { "InspectionSerialNo" });
            AlterColumn("dbo.FabricInspReportExports", "width", c => c.String(maxLength: 10));
            DropColumn("dbo.FabricInspReportExport4PointResults", "InspectionSerialNo");
        }
    }
}
