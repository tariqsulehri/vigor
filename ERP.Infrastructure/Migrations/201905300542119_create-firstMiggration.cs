namespace ERP.Infrastructure.Migrations
{
    ...
    public partial class createfirstMiggration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.FinParties", t => t.CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.IndCommissions", t => t.CommissionId, cascadeDelete: true)
                .ForeignKey("dbo.IndDomestics", t => t.IndentId, cascadeDelete: true)
                .Index(t => t.IndentId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.IndUnitOfMeasures", t => t.UomID, cascadeDelete: true)
                .ForeignKey("dbo.UnitOfRates", t => t.UorID, cascadeDelete: true)
                .Index(t => t.UomID)
                .Index(t => t.UorID);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.FinParties", t => t.CompanyId, cascadeDelete: true)
                .ForeignKey("dbo.IndCommissionInvoices", t => t.CommissionInvoiceNo, cascadeDelete: true)
                .ForeignKey("dbo.UnitOfSales", t => t.UnitOfSaleId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.IndDomesticInquiries", t => t.InquiryId, cascadeDelete: true)
                .ForeignKey("dbo.IndPaymentTerms", t => t.PaymentTermsId, cascadeDelete: true)
                .Index(t => t.InquiryId)
                .Index(t => t.CustomerId)
